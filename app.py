...
# 1. Konfigurasi Halaman agar Full Screen
st.set_page_config(
...
# 2. CSS untuk menghapus padding bawaan Streamlit agar UI kamu mepet ke ujung layar
st.markdown("""
    <style>
        .block-container {
...
# 3. Kode UI/UX Asli Kamu (Ditambah JS Navigasi)
html_final = """
<!DOCTYPE html>
<html lang="id">
<head>
...
<body class="text-white bg-black">
    <header class="sticky top-0 left-0 w-full z-30 px-6 md:px-12 py-4 flex justify-between items-center bg-black bg-opacity-60 backdrop-blur">
        ...
        <a href="#produk" class="nav-item hover:underline">Produk</a>
        <a href="#tentang" class="nav-item hover:underline">Tentang Kami</a>
        <a href="#keuntungan" class="nav-item hover:underline">Keuntungan</a>
        <a href="#daftar" class="nav-item hover:underline">Daftar</a>
        </nav>
    </header>
  ...
  <section class="relative h-screen bg-cover bg-center" style="background-image: url('https://www.woodleys.com/blog/wp-content/uploads/sites/105/2022/02/8-Living-Room-Furniture-Ideas-for-Your-New-Home.jpg');">
    ...
    <div class="relative z-10 max-w-7xl mx-auto h-full flex flex-col justify-center px-6 md:px-12">
      <div class="w-full md:w-1/2">
        ...
        <a href="https://wa.me/6283876788630" class="bg-white text-blue-600 font-semibold px-6 py-3 rounded-full hover:bg-gray-100 transition inline-block">PESAN DISINI</a>
      </div>
    </div>
    ...
    <div class="absolute bottom-6 left-6 text-xs md:text-sm z-20">
        ...
        <p>DWIKARYA<br>
        <a href="https://www.google.com/maps/place/Jl.+Imogiri+Barat+Km+12,+Denokan,+Trimulyo,+Jetis,+Bantul,+Yogyakarta" 
            target="_blank" 
  ...
  <section id="keuntungan" class="bg-white text-gray-800 py-16 px-6 md:px-12 text-center">
    ...
    <p class="max-w-2xl mx-auto text-lg mb-10">
      Kami membuka kesempatan bagi Anda yang ingin menjadi bagian dari perjalanan kami.
    </p>
    ...
    <div class="max-w-md mx-auto mt-10 bg-white p-8 rounded-xl shadow-lg" id="daftar">
      <h2 class="text-2xl font-semibold mb-6 text-center">Formulir Pendaftaran Mitra</h2>
      <form action="https://wa.me/6283876788630" method="get" target="_blank">
        <div class="mb-4 text-left">
          <label class="block text-gray-700 mb-2">Nama Store</label>
          <input type="text" name="store" required class="w-full px-4 py-2 border rounded-md">
        </div>
        <div class="mb-4 text-left">
        ...
        <button type="submit" class="w-full bg-blue-600 text-white px-6 py-3 rounded-full shadow-md hover:bg-blue-700 transition">
